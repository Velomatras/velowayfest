...
class ResultsReferee2017 {

    private $ref_voting_db_name = 'way_voting_referee_2017';
    private $db_table_name = 'way2017';
...
// записываем в библиотеку походов судейские оценки и места занятые походом
                //AppendRateAndPlaceToLibrary_2017($place, $cat, $subcat, $id_z);
                $place++;
            }
            echo "</table>";
            return;
...
//            $rate_sum -= $rate_min;   // в 2017 году не вычитаем акс и
//            $rate_count--;
//            $rate_sum -= $rate_max;
//            $rate_count--;
            if ($rate_count <= 0) {
        ...
        private function subcat_num_to_name($subcat) {
            switch ($subcat) {
                ...
                case 3: $nomination = "Отчёт";
                    $id = "report";
                    break;
                case 4: $nomination = "Лучший поход 2017";
                    $id = "";
                    break;
                default: $nomination = "";
                    $id = "";
