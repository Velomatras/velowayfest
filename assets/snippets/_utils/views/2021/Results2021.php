...
class Results2021
{
    ...
    function showDescr()
    {
		...
		<!--
        <p><a href="http://www.veloway.su/archive/win2021.html">Победители</a></p>
...
<!--
        ...
        <p><a href="[~[*id*]~]?cat=10">Лучший поход 2021</a><br><br></p>

        <p><a href="/maps/Rezultat/2021/Za_vklad_2021.jpg">За вклад в развитие велотуризма</a></p>
        <br><br>!-->
        ...
        <p><a href="test/videovoting.html">Видеоролик</a></p>
		<p><a href="test/film.html">Лучший фильм о походе</a></p>
        <p><a href="test/photovoting.html">Лучшая походная фотография</a></p>
        <p><a href="test/excitingvoting.html">Самый увлекательный отчет</a></p>
		<!--
		<p><a href="archive/quote_2021.html">Лучшая цитата ВелоПути</a></p>
		!-->
        <br><br>

		<!--
        <h3>Оценка судейства:</h3>
        <p><a href="assets/images/news/2021/2021-Zritel.png">Лучший зритель</a></p>
		<br><br>
		
        <p><a href="/maps/Rezultat/2021/Sudya_2021.png">Лучший судья</a></p>
        <br><br>
        
        <h3>Анонимное голосование - наиболее читаемый отчёт:</h3>
        <p><a href="openvoting.html">Приз зрительских симпатий</a></p>
        <br><br>
        <p><a href="http://www.veloway.su/maps/Rezultat/2021/Itog_2021_final.xlsx">Подробные результаты финала в формате
                Excel</a></p>
!-->
        <p><a href="http://www.veloway.su/map/map2021.html" target="_blank">Общая карта треков походов-участников
                конкурса</a></p>

        <p><a href="archive/participants2021.html">Список участников конкурса</a></p>
        <p><a href="archive/rules-2021.html" target="_blank">Положение-2021</a></p>
        <?php
    }
