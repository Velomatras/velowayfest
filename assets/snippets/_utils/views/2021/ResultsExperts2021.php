...
const RATE_WIN_INF = 6.5;
const RATE_WIN_AUT = 6.4; 
const RATE_WIN_UNU = 6.25; 
const RATE_WIN_CHI = 3; 
const RATE_WIN_UNF = 6.25; 
...
// эти параметры меняются год от года
        ...
        $voting_db_name = 'way_voting_expert_2021';
		$voting_db_name2 = 'way_voting_expert_2021_2';
