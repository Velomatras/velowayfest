...
class ResultsReferee2020 {

    private $ref_voting_db_name = 'way_voting_referee_2020';
	private $ref_voting_db_name2 = 'way_voting_referee_2020_2';
    private $db_table_name = 'way2020';

//ВАЖНО! Все константы RATE_WIN необходимо продублировать из сниппета votingRef-2020!
	
//Короткие велопоходы
const RATE_WIN_DIFF_1 = 7;
const RATE_WIN_ORG_1 = 7;
const RATE_WIN_OTCH_1 = 8;

//Велопоходы
const RATE_WIN_DIFF_2 = 8;
const RATE_WIN_ORG_2 = 7.5;
const RATE_WIN_OTCH_2 = 7.5;
