...
class Results2016 {
    ...
    function show() {
        ...
        if ($cat == 6) {
            ...
            <div style="padding: 10px; margin: 10px; width: 900px; background-color:#FFFFD7; font-size:16px; font-weight:bold">
                Самый протяженный поход
            </div> <?php
            $zayavkaList   = new zayavkaList($zayavka);
            $zayavkaList->load(Array('status' => 1));
            foreach ($zayavkaList->list as &$row) {
                $row['sortField'] = $row['mileage'];
            }
        } elseif ($cat == 7) {
            $sortParamName = 'дней';
            ?> <br>
            <div style="padding: 10px; margin: 10px; width: 900px; background-color:#FFFFD7; font-size:16px; font-weight:bold">
                Cамый длительный поход
            </div> <?php
            $zayavkaList   = new zayavkaList($zayavka);
            $zayavkaList->load(Array('status' => 1));
            foreach ($zayavkaList->list as &$row) {
                $row['sortField'] = Period::get_trip_duration($row['period']);
                if ($row['id'] == 33) {  // Заявка Зелезея Валерия - из кучи мелких 2-дневных походов, поэтому такие извраты со сроками
                    $row['sortField'] = 2;
                }
            }
        } elseif ($cat == 8) {
            ...
            foreach ($zayavkaList->list as &$row) {
                ...
                $row['sortField'] = $dur ? $row['mileage'] / $dur : 0;
            }
        }

        usort($zayavkaList->list, function($a, $b) {
            $d1 = $a['sortField'];
            $d2 = $b['sortField'];
            if ($d1 == $d2)
                return 0;
    ...
    function showDescr() {
        ...
        <p><a href="maps/Rezultat/2016/Itog_2016.png">Лучший поход 2016</a></p>
        <p><a href="/maps/Rezultat/2016/Za_vklad_2016.jpg">За вклад в развитие велотуризма</a></p>
        <br><br>
        <h3>Номинации со зрительской оценкой:</h3>
        <p><a href="archive/videovoting.html2016">Лучший видеоролик о походе</a></p>
        <p><a href="archive/photovoting.html2016">Лучшая походная фотография</a></p>
        <p><a href="archive/excitingvoting2016.html">Самый увлекательный отчет</a></p>
        <br><br>
        <h3>Номинации со статистической оценкой:</h3>
        <p><a href="[~[*id*]~]?cat=6">Самый продолжительный маршрут</a></p>
        <p><a href="[~[*id*]~]?cat=7">Самый длинный маршрут</a></p>
        ...
        <p><a href="/maps/Rezultat/2016/Luc_zritel.png">Лучший зритель</a></p>
        <p><a href="/maps/Rezultat/2016/Luc_sudya.png">Лучший судья</a></p>
        <br><br>
        <h3>Анонимное голосование - наиболее читаемый отчёт:</h3>
        <p><a href="archive/openvoting2016.html">Приз зрительских симпатий</a></p>
        <br><br>
        <p><a href="http://www.veloway.su/maps/Rezultat/2016/Rezultat_zritel_2016.xlsx">Подробные результаты по зрительским номинациям в формате Excel</a></p>
        <p><a href="http://www.veloway.su/maps/Rezultat/2016/Rezultat_sudia_2016.xlsx">Подробные результаты по судейским номинациям в формате Excel</a></p>
        <p><a href="http://www.veloway.su/map/map2016.html" target="_blank">Общая карта треков походов-участников конкурса</a></p>

        <p><a href="archive/participants2016.html">Список участников конкурса</a></p>
        <p><a href="archive/rules-2016.html" target="_blank">Положение о конкурсе</a></p>
        <?php
    }
