...
// эти параметры меняются год от года
        $YEAR_TAG = '2022';
        $db_table_name = 'way2022';
        $voting_db_name = 'way_voting_expert_2022';
		$voting_db_name2 = 'way_voting_expert_2022_2';
        $zayavka_Info_Url = 'archive/participant-2022.html';
        $zayavka = new Zayavka2022;
