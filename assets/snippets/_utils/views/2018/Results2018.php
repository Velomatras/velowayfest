...
class Results2018 {
    ...
    function show() {
        ...
        $zayavka_Info_Url = 'archive/participant-2018.html';
        $YEAR_TAG         = '2018';
        $zayavka          = new Zayavka2018;
    ...
    function showDescr() {
        ...
        <h3>Дополнительные номинации:</h3>
               <p><a href="maps/Rezultat/2018/Luc_poxod.png">Лучший поход 2018</a></p>
			   <p><a href="maps/Rezultat/2018/Luc_debut.png">Лучший дебют</a></p>
			   <!-- 
       ...
       <p><a href="[~[*id*]~]?cat=5&subcat=1">Самый познавательный маршрут</a></p>
        ...
        <!--<p><a href="[~[*id*]~]?cat=9">Лучший дебютант</a></p>!-->        
        <br><br>
		<h3>Номинации со зрительской оценкой:</h3>
        <p><a href="archive/videovoting2018.html">Лучший видеоролик о походе</a></p>
        <p><a href="archive/photovoting2018.html">Лучшая походная фотография</a></p>
        <p><a href="archive/excitingvoting2018.html">Самый увлекательный отчет</a></p>
        <br><br>
        <h3>Оценка судейства:</h3>
        <p><a href="/maps/Rezultat/2018/Luc_zritel.png">Лучший зритель</a></p>
        <p><a href="/maps/Rezultat/2018/Luc_sudya.png">Лучший судья</a></p>
        <br><br>
        <h3>Анонимное голосование - наиболее читаемый отчёт:</h3>
        <p><a href="archive/openvoting2018.html">Приз зрительских симпатий</a></p>
        <br><br>
        <p><a href="http://www.veloway.su/maps/Rezultat/2018/Itog_2018.xlsx">Подробные результаты в формате Excel</a></p>
       
       <p><a href="http://www.veloway.su/map/map2018.html" target="_blank">Общая карта треков походов-участников конкурса</a></p>
        <p><a href="archive/participants2018.html">Список участников конкурса</a></p>
        <p><a href="archive/rules-2018.html" target="_blank">Положение о конкурсе</a></p>
        <?php
    }
