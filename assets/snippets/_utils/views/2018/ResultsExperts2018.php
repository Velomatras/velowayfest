...
class ResultsExperts2018 {

    function show() {

// эти параметры меняются год от года
        $YEAR_TAG = '2018';
        $db_table_name = 'way2018';
        $voting_db_name = 'way_voting_expert_2018';
...
// выводим очередную строку таблицы
                ...
                ?> <tr> <?php
                    ...
                    $zayavkaView->column2();
                    $zayavkaView->column3();
                    print_rates(Array('<span style="color: red">'.sprintf ("%.2f", $resultRate).'</span>', $resultRateCount));
                    ?> </tr>
                <?php $zayavkaView->hr5(); ?>
                <?php
