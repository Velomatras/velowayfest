...
function ZayavkaEditorSave($oldZayavka, $moderatorId) {
...
function ZayavkaEditorDelConfirm(){
    $idz = ParamsWork::sanitizeInt($_REQUEST['idz']);
    ?>
    <form enctype="multipart/form-data" method="POST" action="">
        <p>
            Удалить заявку?
            <br>
            <?php GUIHelpers::setHiddenField('idz', $idz);
...
function ZayavkaEditorEdit($zayavka){
    ?>
    ...
    <form enctype="multipart/form-data" method="POST" action="">
        ...
        <p>
            ...
            <br>
    <?php printNominationsSelector(Zayavka2019, DBDataWork::unpackArray($zayavka->data['nominations'])); ?>
            <br>
    ...
    <?= RegionWork::populateRegionSelectList(RegionWork::unpack($zayavka->data['region'])); ?>
        ...
        <p id="photo-block"><label for="">Загрузить фотографии:</label>
			...
			<label for="photo01">Название фото №1</label>
			<input maxlength="60" name="photo01" size="40" type="text" value="<?= $zayavka->data['photo01'] ?>" />
			<br>
            <input type="file" name="photo2" accept="image/*,image/jpeg"  /><br>
			<label for="photo02">Название фото №2</label>
			<input maxlength="60" name="photo02" size="40" type="text" value="<?= $zayavka->data['photo02'] ?>" />
			<br>
            <input type="file" name="photo3" accept="image/*,image/jpeg"  /><br>
			<label for="photo03">Название фото №3</label>
			<input maxlength="60" name="photo03" size="40" type="text" value="<?= $zayavka->data['photo03'] ?>" />
			<br>
        </p>
        <span>
	<br><br>
