...
class ResultsReferee2023 {

    private $ref_voting_db_name = 'way_voting_referee_2023';
	private $ref_voting_db_name2 = 'way_voting_referee_2023_2';
    private $db_table_name = 'way2023';

//ВАЖНО! Все константы RATE_WIN необходимо продублировать из сниппета votingRef-2023!
...
const RATE_WIN_DIFF_20 = 7;
const RATE_WIN_ORG_20 = 7;
const RATE_WIN_OTCH_20 = 7;											   
...
// Заголовок страницы
        ...
        <div style="padding: 10px; margin: 10px; width: 900px; background-color:#FFFFD7; font-size:16px; font-weight:bold">
			...
			if ( strcmp($class, $bestDiff) != 0) echo "<i>класс:</i> $class";
         ...
         function cat_num_to_class($cat) {
            switch ($cat) {
                ...
                case 5: $class = "";    //"Лучший поход";
                    break;
				case 20: $class = "Самый cложный поход Года";    //"Лучший поход";
                    break;	
...
$namesRef[$s++] = ModXWork::getUserName($array5[3]);  
		...
		//Подсчёт дисперсии
		public static function dispers ($array){
