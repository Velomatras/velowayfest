...
// Заголовок страницы
		...
		<i>*Результат - средний балл по всем номинациям</i>
		</div>
        <table width="100%"  border="0" cellspacing="2" cellpadding="0">
			...
			foreach ($rates as $value) {
                ...
                if (!$resultRate || strcmp($value['class'], "ПВД") != 0){
				...
				echo "<td><b>оценки за номинации:</b></td>";
					...
					// $yellow = $this->max3_yellow($max1, $max2, $max3);
					 ...
					 if ($resultDiff >= $value['max3'] && $flag < 3){
						 if (($resultDiff == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
					...
					// echo "+" . $value['max1'] . $value['max2'] . $value['max3'] . $value['rate'];
					 ...
					 if ($resultOrg >= $value['max3'] && $flag < 3){
						 if (($resultOrg == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultOtch >= $value['max3'] && $flag < 3){
						  if (($resultOtch == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultInf >= $value['max3'] && $flag < 3){
						 if (($resultInf == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultAut >= $value['max3'] && $flag < 3){
						 if (($resultAut == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultChi >= $value['max3'] && $flag < 3){
						  if (($resultChi == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultUnu >= $value['max3'] && $flag < 3){
						 if (($resultUnu == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultUnf >= $value['max3'] && $flag < 3){
						  if (($resultUnf == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultFoto >= $value['max3'] && $flag < 3){
						 if (($resultFoto == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultVideo >= $value['max3'] && $flag < 3){
						 if (($resultVideo == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultMovie >= $value['max3'] && $flag < 3){
						 if (($resultMovie == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
					 ...
					 if ($resultExc >= $value['max3'] && $flag < 3){
						 if (($resultExc == $value['max3']) && ($yellow > 1)) {
							 $yellow = $yellow - 1;
						 ?>
					 					 <td style="border: 1px solid black; background: yellow;" align="center">
					  <?php
...
rate_unf, rate_foto_1, rate_foto_2, rate_foto_3, rate_video, rate_videoLong, rate_exciting, class FROM $db_table_name WHERE status = '1'";
$q2 = "SELECT id, rate_diff, rate_org, rate_otch, rate_inf, rate_aut, rate_chi, rate_unu, 
rate_unf, rate_foto_1, rate_foto_2, rate_foto_3, rate_video, rate_videoLong, rate_exciting, class FROM $db_table_name WHERE status = '-2'";
