...
class Results2019 {
    ...
    function showDescr() {
        ?>
		<h2> "Путь-2019"</h2>
		<p><a href="http://www.veloway.su/archive/win2019.html">Победители</a></p>
		<p><a href="https://youtu.be/WrbcmpQzpKY">Видео церемонии подведения итогов</a></p>
		<br>
        ...
        <h3>Дополнительные номинации:</h3>
               ...
               <p><a href="[~[*id*]~]?cat=10">Лучший поход 2019</a></p>
			   
			   
			   
        <p><a href="/maps/Rezultat/2019/Za_vklad_2019.jpg">За вклад в развитие велотуризма</a></p> 
        <br><br>
       ...
       <p><a href="[~[*id*]~]?cat=5&subcat=1">Самый познавательный маршрут</a></p>
        ...
        <p><a href="archive/videovoting2019.html">Лучший видеоролик о походе</a></p>
        <p><a href="archive/photovoting2019.html">Лучшая походная фотография</a></p>
        <p><a href="archive/excitingvoting2019.html">Самый увлекательный отчет</a></p>
        <br><br>
		 
        <h3>Оценка судейства:</h3>
        <p><a href="/maps/Rezultat/2019/Zritel_2019.png">Лучший зритель</a></p>
        <p><a href="/maps/Rezultat/2019/Sudya_2019.png">Лучший судья</a></p>
        <br><br>
		<!--
        <h3>Анонимное голосование - наиболее читаемый отчёт:</h3>
        <p><a href="openvoting.html">Приз зрительских симпатий</a></p>
        <br><br>!-->
        <p><a href="http://www.veloway.su/maps/Rezultat/2019/Itog_2019_final.xlsx">Подробные результаты финала в формате Excel</a></p>
       
        <p><a href="http://www.veloway.su/map/map2019.html" target="_blank">Общая карта треков походов-участников конкурса</a></p>

        <p><a href="archive/participants2019.html">Список участников конкурса</a></p>
        <p><a href="archive/rules-2019.html" target="_blank">Положение-2019</a></p>
        <?php
    }
