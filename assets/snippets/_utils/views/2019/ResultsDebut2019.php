...
// Заголовок страницы
		...
		<br>
		(В этой номинации принимают участие только те отчёты, котрые участвовали не менее чем в трёх номинациях и авторы впервые заявили отчёт
		на Фестиваль "Велопуть")
...
if ($idz != 10 && $idz != 39 && $idz != 44 && $idz != 50 && $idz != 58 && $idz != 61 && $idz != 78 &&
$idz != 95 && $idz != 103) continue; //Не учитываем походы не являющиеся дебютными!!!
...
rate_unf, rate_foto_1, rate_foto_2, rate_foto_3, rate_video, rate_exciting FROM $db_table_name WHERE status = '-2'";
