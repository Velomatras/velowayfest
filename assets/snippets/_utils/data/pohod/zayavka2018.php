...
class Zayavka2018 extends Zayavka {

    const MIN_START_DATE_FOR_VELOTRIPS = '01.01.2017';
    const MIN_START_DATE = '01.01.2018';

    static public $db_table_name = 'way2018';
    static public $YEAR_TAG = '2018';
    static public $COVER_IMG_SAVE_PATH = '/assets/images/way-2018';
    static public $PHOTO_SAVE_PATH = '/assets/images/way-2018/_photos';
