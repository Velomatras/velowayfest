...
class Zayavka2020 extends Zayavka {

    const MIN_START_DATE_FOR_VELOTRIPS = '01.01.2019';
    const MIN_START_DATE = '01.01.2020';

    static public $db_table_name = 'way2020';
    static public $YEAR_TAG = '2020';
    static public $COVER_IMG_SAVE_PATH = '/assets/images/way-2020';
    static public $PHOTO_SAVE_PATH = '/assets/images/way-2020/_photos';
