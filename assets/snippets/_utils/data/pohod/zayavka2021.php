...
class Zayavka2021 extends Zayavka {

    const MIN_START_DATE_FOR_VELOTRIPS = '01.01.2020';
    const MIN_START_DATE = '01.01.2021';

    static public $db_table_name = 'way2021';
    static public $YEAR_TAG = '2021';
    static public $COVER_IMG_SAVE_PATH = '/assets/images/way-2021';
    static public $PHOTO_SAVE_PATH = '/assets/images/way-2021/_photos';
