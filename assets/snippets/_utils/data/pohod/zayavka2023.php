...
class Zayavka2023 extends Zayavka {

    const MIN_START_DATE_FOR_VELOTRIPS = '01.01.2022';
    const MIN_START_DATE = '01.01.2023';

    static public $db_table_name = 'way2023';
    static public $YEAR_TAG = '2023';
    static public $COVER_IMG_SAVE_PATH = '/assets/images/way-2023';
    static public $PHOTO_SAVE_PATH = '/assets/images/way-2023/_photos';
