...
class Zayavka2016 extends Zayavka {

    const MIN_START_DATE_FOR_VELOTRIPS = '01.01.2015';
    const MIN_START_DATE = '01.01.2016';

    static public $db_table_name = 'way2016';
    static public $YEAR_TAG = '2016';
    static public $COVER_IMG_SAVE_PATH = '/assets/images/way-2016';
    static public $PHOTO_SAVE_PATH = '/assets/images/way-2016/_photos';
    static protected $Nominations = Array(
        ...
        Array('Фотоконкурс компании "Снаряжение"', "snar"),
